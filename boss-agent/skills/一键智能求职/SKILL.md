...
allowed-tools: [get_user_profile, get_memory, getjob_service_manage, platform_status, platform_update_config, platform_start_task, platform_stop_task, sync_jobs, platform_stats, query_jobs, fetch_job_detail, get_stats]
---
